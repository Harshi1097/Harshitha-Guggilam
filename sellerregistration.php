...
<h2 style="color:pink;"><center>SELLER REGISTRATION</center></h2>

  <form  id="myform" name="myForm" 
  action="sellersignup.php" method="post">
